...
| Pack | What it is |
| --- | --- |
| `signature-pack` | the **default** — StarEnchants' own flagship library, already live when you first start the server |
| `cosmic-pack` | the classic Cosmic experience, ported number-exact: its enchant library, armour sets, socketable crystals, masks, pets, and the Heroic gear tier |
