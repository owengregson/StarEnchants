 ...
 */
class DamageArmorEffectTest {

    @Test
    void emitsOneDamageArmorIntentPerResolvedTarget() {
        ...
        new DamageArmorEffect().run(ctx, sink);

        verify(sink).damageArmor(a, 50);
        verify(sink).damageArmor(b, 50);
