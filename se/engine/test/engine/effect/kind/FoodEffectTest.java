...
/**
 * Mock-host test for the canonical {@code MODIFY_FOOD} (which replaced FEED): give feeds each player
 * target, take drains them, and non-players are skipped (only players have a hunger bar).
 */
