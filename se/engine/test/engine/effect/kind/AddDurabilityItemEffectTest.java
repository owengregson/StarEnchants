 ...
 */
class AddDurabilityItemEffectTest {

    @Test
    void emitsOneRepairHandIntentPerResolvedPlayer() {
        ...
        new AddDurabilityItemEffect().run(ctx, sink);

        verify(sink).repairHand(a, 200);
        verify(sink).repairHand(b, 200);
