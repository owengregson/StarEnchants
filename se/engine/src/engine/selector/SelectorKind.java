 ...
 * (docs/architecture.md §3.5). Implementations MUST be stateless — one shared instance is reused across
 * all activations and threads. Adding a selector is implementing this interface plus one line in
