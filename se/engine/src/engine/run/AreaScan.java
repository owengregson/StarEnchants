...
public interface AreaScan {
    ...
    /**
     * The default for contexts with no world-access provider: area/roster/raytrace selectors resolve to
     * nothing. Used in unit/synthetic contexts; direct selectors (Self/Victim/Attacker) never call it, so
