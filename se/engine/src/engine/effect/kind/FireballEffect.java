 ...
 * not from a resolved selector. {@link Affinity#TARGET_ENTITY}: the launch is a
 * shooter-context call ({@code shooter.launchProjectile(...)}), so on Folia the
 * {@code Sink} routes the intent to the shooter's own thread (§3.6) — the author only
 * declares it.
 */
