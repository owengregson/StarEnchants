...
/**
 * {@code EXP_MULTIPLY} — accumulate a factor the EXP_GAIN or MINE dispatcher applies to the triggering
 * event's XP amount. Scaling the event in place is recursion-safe (granting new XP would
...
public final class ExpMultiplyEffect implements EffectKind {
    ...
    static final EffectSpec SPEC = EffectSpec.of("EXP_MULTIPLY")
            ...
            .doc("Multiply XP on the triggering EXP_GAIN or MINE event by a factor.")
