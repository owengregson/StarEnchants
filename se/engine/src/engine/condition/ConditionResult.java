...
/**
 * The result of evaluating a compiled condition: a {@link Flow} and a chance delta. The pipeline adds
 * {@link #chanceDelta()} to the ability's base chance before the roll.
 *
