...
/**
 * The configurable command that fires the {@code COMMAND} trigger (§B, ADR-0022) — a Cosmic Enchants-style
 ...
 * Player-only: a non-player sender has no worn items to scan.
 */
