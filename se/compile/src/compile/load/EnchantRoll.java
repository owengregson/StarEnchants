 ...
 * @param chance percent probability {@code (0,100]} that the entry mints at all; 100 for an unconditional one
 * @param mode   how a level is drawn between {@link #min} and {@link #max}
 */
public record EnchantRoll(int min, int max, int chance, Mode mode) {
