...
public record ItemsConfig(Optional<SoulGemConfig> soulGem, Optional<CrystalConfig> crystal,
                          ...
                          Optional<MaskItemConfig> mask, Optional<ReforgeItemConfig> reforge,
    ...
    public PetItemConfig petOrDefault() {
        return pet.orElseGet(PetItemConfig::defaults);
    }
    ...
    public ReforgeItemConfig reforgeOrDefault() {
        return reforge.orElseGet(ReforgeItemConfig::defaults);
    }
