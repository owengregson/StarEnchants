...
class RegistryWiringTest {
    ...
    private static final List<String> GOLDEN_STOPS = List.of(
            ...
            "falling-block casts", "guardian casts", "combat tags", "damage marks", "owner zones", "temp equips", "decay ladders", "turret casts", "potion reductions", "dispatch faults", // stores
