 ...
 *
 * <p>{@link schema.grammar.Lexer} splits a line on a delimiter
 ...
 * {@link schema.grammar.EffectLine} is the resulting head +
 * column-tagged argument {@link schema.grammar.Tok}s. No
