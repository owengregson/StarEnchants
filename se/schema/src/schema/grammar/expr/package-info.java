 ...
 * <ul>
 *   <li>{@link schema.grammar.expr.ExprLexer} tokenizes the text
 *       into {@link schema.grammar.expr.ExprTok}s with 1-based
 *       columns;
 *   <li>{@link schema.grammar.expr.ExprParser} parses those tokens
 *       with correct precedence
 *       ({@code ||} &lt; {@code &&} &lt; comparators &lt; unary {@code !} &lt;
 *       primary) into an immutable
 *       {@link schema.grammar.expr.Expr} tree of flyweight nodes
 ...
 * {@link schema.grammar.expr.Expr.VarRef} to be resolved later.
 ...
 * {@link schema.diag.Diagnostic} and the parser recovers with a
